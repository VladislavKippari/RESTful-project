...
db.country.belongsToMany(db.city, { through: 'country_city', foreignKey: 'countryCode', otherKey: 'code'});
db.city.belongsTo(db.country, { through: 'country_city', foreignKey: 'code', otherKey: 'countryCode'});
module.exports = db;
module.exports = db;
